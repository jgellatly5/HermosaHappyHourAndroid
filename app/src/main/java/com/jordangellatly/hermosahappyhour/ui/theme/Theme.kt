package com.jordangellatly.hermosahappyhour.ui.theme
...
private val LightColorPalette = HermosaHappyHourColors(
    brand = Shadow5,
...
private val DarkColorPalette = HermosaHappyHourColors(
    brand = Shadow1,
...
fun HermosaHappyHourTheme(
    ...
    ProvideHermosaHappyHourColors(colors) {
        MaterialTheme(
...
object HermosaHappyHourTheme {
    val colors: HermosaHappyHourColors
        @Composable
        get() = LocalHermosaHappyHourColors.current
}

@Stable
class HermosaHappyHourColors(
    ...
    fun update(other: HermosaHappyHourColors) {
    ...
    fun copy(): HermosaHappyHourColors = HermosaHappyHourColors(
...
@Composable
fun ProvideHermosaHappyHourColors(
    colors: HermosaHappyHourColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalHermosaHappyHourColors provides colorPalette, content = content)
}

private val LocalHermosaHappyHourColors = staticCompositionLocalOf<HermosaHappyHourColors> {
    error("No HermosaHappyHourColorPalette provided")
}
